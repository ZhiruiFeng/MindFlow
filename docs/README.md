...
Complete documentation for the MindFlow macOS voice-to-text assistant.
...
For coding standards and regulations, see:
...
**New to MindFlow?** Start here:
1. Read the [Quick Start Guide](./guides/quick-start.md)
2. Check the [Project README](../README.md)
3. Review the [Design Plan](./architecture/design-plan.md)
...
2. [Permission Fixes](./troubleshooting/permission-fixes.md) - Permission issues
3. [GitHub Issues](https://github.com/yourusername/MindFlow/issues) - Report bugs
...
- Review the [coding standards](../spec/coding-regulations/)

---

**MindFlow** - Turn your voice into elegant text ✨
